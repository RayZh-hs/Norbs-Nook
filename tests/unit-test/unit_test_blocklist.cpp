...
int main() {
    ...
    f_global.seekg(0);
    norb::algo::FiledBlockList<int, norb::string<10>, norb::bounds::int_bounds, norb::bounds::str_bounds<10>> block_list_1("head1.testdata", "body1.testdata", f_global);
    norb::algo::FiledBlockList<int, int, norb::bounds::int_bounds, norb::bounds::int_bounds> block_list_2("head2.testdata", "body2.testdata", f_global);
